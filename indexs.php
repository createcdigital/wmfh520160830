...
<body>
    ...
    <script>
        ...
        function shareChange(msg) {
            ...
            var info = {
                'act':'share',
                't':'WMF携豪礼提醒您：秋运你团圆了吗',
                'w':'朋友，我的秋运团聚餐桌为你留了一个好位置，不点进来吗？',
                'p':'http://assetscdn.createcdigital.com/wmfh520160830/assets/share-icon.jpg',
                'h': app.sharUrl
            };
            sharecontent_formeishijie = btoa(JSON.stringify(info));
        }
    ...
    <?php if(strpos($http_agent,'android') !== false):?>
            <div class="sharebtn_in_con_sx" onClick="window.androidWeb.nativeMethod('" + sharecontent_formeishijie +"')">分<br>享</div>
    <?php else:?>
            <script type="text/javascript">function CallNative(){document.location = "meishijiewebsso:" + "&func=" + sharecontent_formeishijie;}</script>
            <div class="sharebtn_in_con_sx" onClick="CallNative()">分<br>享</div>
    <?php endif;?>
    <?php endif;?>
